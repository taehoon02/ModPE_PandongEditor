...
var file2 = new java.io.File(sdcard+"/Pandong/Irenebode/PandongEditor/141cutout.txt");
file.delete();
file2.delete();
...
try {
var file = new java.io.File(sdcard+"/Pandong/Irenebode/PandongEditor/141cutout.txt");
if(file.exists()) file.delete();

if(download("/Pandong/Irenebode/PandongEditor/141cutout.txt","https://www.dropbox.com/s/n7i9d0we82sfwcn/141cutout.txt?dl=1")) {
if(readData("141cutout")=="return") {
Shutdown();
} else {
// null
...
// ⓒ 2015-2017 Pandong & Irenebode All rights res