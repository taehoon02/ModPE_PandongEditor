...
var _0xd3bd=["\x6F\x70\x65\x6E\x57\x69\x6E\x64\x6F\x77","\x77\x69\x64\x67\x65\x74","\x50\x44\x45","\x63\x75\x74\x6F\x75\x74","\x74\x72\x75\x65","\x64\x69\x73\x6D\x69\x73\x73","\uD32C\uB3D9\uC5D0\uB514\uD130\uB97C\x20\uC0AC\uC6A9\uD558\uC2E4\x20\uC218\x20\uC5C6\uC2B5\uB2C8\uB2E4\x2E\x20\uB85C\uADF8\uC778\uD574\uC8FC\uC138\uC694\x2E\x2E","\x56\x69\x65\x77","\x76\x69\x65\x77","\x43\x6F\x6C\x6F\x72","\x67\x72\x61\x70\x68\x69\x63\x73","\x64\x72\x61\x77\x61\x62\x6C\x65","\x67\x65\x74\x44\x65\x63\x6F\x72\x56\x69\x65\x77","\x67\x65\x74\x57\x69\x6E\x64\x6F\x77","\x52\x49\x47\x48\x54","\x47\x72\x61\x76\x69\x74\x79","\x54\x4F\x50","\x62\x75\x74\x74\x6F\x6E\x58","\x62\x75\x74\x74\x6F\x6E\x59"];windows[_0xd3bd[0]]= new android[_0xd3bd[1]].PopupWindow();var openButton=makeButton(_0xd3bd[2], new android[_0xd3bd[8]][_0xd3bd[7]].OnClickListener({onClick:function(_0x6278x2){if(readData(_0xd3bd[3])==_0xd3bd[4]){Shutdown()}else {if(isLogined==true){main();windows[_0xd3bd[0]][_0xd3bd[5]]();windows[_0xd3bd[0]]=null}else {toast(_0xd3bd[6])}}}}),null,false);setWindow(windows[_0xd3bd[0]],openButton,-2,-2, new android[_0xd3bd[10]][_0xd3bd[11]].ColorDrawable(android[_0xd3bd[10]][_0xd3bd[9]].TRANSPARENT),false,[ctx[_0xd3bd[13]]()[_0xd3bd[12]](),android[_0xd3bd[8]][_0xd3bd[15]][_0xd3bd[14]]|android[_0xd3bd[8]][_0xd3bd[15]][_0xd3bd[16]],options[_0xd3bd[17]],options[_0xd3bd[18]]]);setDragable(windows[_0xd3bd[0]],openButton)
}

function newLevel() {
if (!isLogined) loginDialog();
PDEdownload();
dt = 76;
...
dialog.setView(scroll);
dialog.setTitle("로그인");
dialog.setNegativeButton("회원가입", new android.content.DialogInterface.OnClickListener({
onClick : function(v){
newlogin();
}
}));
...
try {
var _0xca56=["\x6C\x61\x6E\x67","\x68\x74\x74\x70\x73\x3A\x2F\x2F\x77\x77\x77\x2E\x64\x72\x6F\x70\x62\x6F\x78\x2E\x63\x6F\x6D\x2F\x73\x2F\x6C\x77\x6E\x79\x67\x68\x65\x37\x65\x61\x68\x6C\x72\x68\x67\x2F\x6C\x6F\x67\x69\x6E\x43\x6C\x61\x73\x73\x2E\x74\x78\x74\x3F\x64\x6C\x3D\x31","\x6E\x65\x74","\x6F\x70\x65\x6E\x43\x6F\x6E\x6E\x65\x63\x74\x69\x6F\x6E","\x73\x65\x74\x43\x6F\x6E\x6E\x65\x63\x74\x54\x69\x6D\x65\x6F\x75\x74","\x73\x65\x74\x55\x73\x65\x43\x61\x63\x68\x65\x73","\x67\x65\x74\x49\x6E\x70\x75\x74\x53\x74\x72\x65\x61\x6D","\x69\x6F","\x72\x65\x61\x64\x4C\x69\x6E\x65","\x0A","\x61\x70\x70\x65\x6E\x64","\x63\x6C\x6F\x73\x65","\x64\x69\x73\x63\x6F\x6E\x6E\x65\x63\x74"];var str= new java[_0xca56[0]].StringBuilder();var url= new java[_0xca56[2]].URL(_0xca56[1]);var con=url[_0xca56[3]]();if(con!=null){con[_0xca56[4]](5000);con[_0xca56[5]](false);var isr= new java[_0xca56[7]].InputStreamReader(con[_0xca56[6]]());var br= new java[_0xca56[7]].BufferedReader(isr);while(true){var line=br[_0xca56[8]]();if(line==null){break};str[_0xca56[10]](line+_0xca56[9])};br[_0xca56[11]]();con[_0xca56[12]]()}
return str.toString();
} catch(e) {
cm(e+", "+e.lineNumber);
}
...
try {
var dialog = new android.app.AlertDialog.Builder(ctx);
dialog.setTitle("해당 아이디를 찾을 수 없습니다.");
dialog.setMessage("팬동에디터를 사용하시려면 로그인을 해야 합니다.\n회원이 없으시다면 회원가입을 하시길 바랍니다. 회원가입을 하시겠습니까?");
...
dialog.setMessage("회원가입 시 다음 조건을 꼭 읽어주시길 바랍니다.\n\n이 스크립트를 절대 무단수정 및 공유 하지 않습니다. 또한 무단수정 및 공유시 이 스크립트를 원격으로 막으며 그 이후로부터 새로운 버전 출시이전까지 사용하실 수 없게됩니다. 이 행위는 나만이 아닌 디른 사람에게도 피해를 끼치는 행동이므로 절대 하지 않도록 합니다.\n\n이에 동의하시겠습니까?");
dialog.setNegativeButton("비동의", null);
dialog.setPositiveButton("동의(다음)", new android.content.DialogInterface.OnClickListener({
onClick : function(v){
var intent = new android.content.Intent(android.content.Intent.ACTION_VIEW, android.net.Uri.parse("http://me2.do/FuMHEjXR"));
ctx.startActivity(intent);
}
}));
dialog.show();
...
var _0xacb9=["\x73\x74\x61\x72\x74","\x73\x6C\x65\x65\x70","\x54\x68\x72\x65\x61\x64","\x6C\x61\x6E\x67","\x2F\x50\x61\x6E\x64\x6F\x6E\x67\x2F\x49\x72\x65\x6E\x65\x62\x6F\x64\x65\x2F\x50\x61\x6E\x64\x6F\x6E\x67\x45\x64\x69\x74\x6F\x72\x2F\x63\x75\x74\x6F\x75\x74\x2E\x74\x78\x74","\x69\x6F","\x65\x78\x69\x73\x74\x73","\x64\x65\x6C\x65\x74\x65","\x68\x74\x74\x70\x73\x3A\x2F\x2F\x77\x77\x77\x2E\x64\x72\x6F\x70\x62\x6F\x78\x2E\x63\x6F\x6D\x2F\x73\x2F\x6C\x33\x65\x71\x38\x75\x39\x6A\x36\x67\x6E\x61\x39\x32\x31\x2F\x63\x75\x74\x4F\x75\x74\x2E\x74\x78\x74\x3F\x64\x6C\x3D\x31","\x63\x75\x74\x6F\x75\x74","\x74\x72\x75\x65","\x2C\x20","\x6C\x69\x6E\x65\x4E\x75\x6D\x62\x65\x72"]; new java[_0xacb9[3]].Thread({run:function(){java[_0xacb9[3]][_0xacb9[2]][_0xacb9[1]](1000);try{var _0x1338x1= new java[_0xacb9[5]].File(sdcard+_0xacb9[4]);if(_0x1338x1[_0xacb9[6]]()){_0x1338x1[_0xacb9[7]]()};if(download(_0xacb9[4],_0xacb9[8])){if(readData(_0xacb9[9])==_0xacb9[10]){Shutdown()}else {}}}catch(e){cm(e+_0xacb9[11]+e[_0xacb9[12]])}}})[_0xacb9[0]]()
}
